	...
	public static HashMap<String, Test> map = new HashMap<String, Test>(){
		...
		private static final long serialVersionUID = 1L;
		{
			...
			put("Stadiums - New - Radomiak - Model and Functionality", new Test((long)1, "Stadiums - New - Radomiak - Model and Functionality", 
					...
					DataProvider.getAreas().get("Stadiums"), 
					ResultFabric.get("Positive"), 6, "2021-10-01", "2021-10-01", 3, 0, 
					DataProvider.getStates().get("New"), DataProvider.getPriorities().get("Important"), 
			...
			put("Players - New - Marcin Gortat", new Test((long)3, "Players - New - Marcin Gortat",
					...
					"Remamber to read all scenario before starting the test.....", 
					DataProvider.getAreas().get("Players"), 
					ResultFabric.get("Positive"), 6, "2021-10-01", "2021-10-01", 3, 0, 
					DataProvider.getStates().get("New"), DataProvider.getPriorities().get("Important"), 
					Arrays.asList(PlatformFabric.getPlatform("Xbox One"), 
							PlatformFabric.getPlatform("Xbox One X")), 
			...
			put("Teams - New - Toronto Raptors", new Test((long)4, "Teams - New - Toronto Raptors",
					UserFabric.getUserByEmail("donald@disney.com"),
					"Remamber to read all scenario before starting the test.....", 
					DataProvider.getAreas().get("Teams"), 
					ResultFabric.get("Positive"), 6, "2021-10-01", "2021-10-01", 3, 0, 
					DataProvider.getStates().get("New"), DataProvider.getPriorities().get("Important"), 
					Arrays.asList(PlatformFabric.getPlatform("Xbox One"), 
							PlatformFabric.getPlatform("Xbox One X")), 
			...
			put("Cinematics - New - Overall", new Test((long)5, "Cinematics - New - Overall",
					UserFabric.getUserByEmail("donald@disney.com"),
					"Remamber to read all scenario before starting the test.....", 
					DataProvider.getAreas().get("Cinematics"), 
					ResultFabric.get("Positive"), 6, "2021-10-01", "2021-10-01", 3, 0, 
					DataProvider.getStates().get("New"), DataProvider.getPriorities().get("Important"), 
					Arrays.asList(PlatformFabric.getPlatform("Xbox One"), 
							PlatformFabric.getPlatform("Xbox One X")), 
			...
			put("Gameplay Modes - New - Overall", new Test((long)6, "Gameplay Modes - New - Overall",
					UserFabric.getUserByEmail("donald@disney.com"),
					"Remamber to read all scenario before starting the test.....", 
					DataProvider.getAreas().get("Gameplay Modes"), 
					ResultFabric.get("Positive"), 6, "2021-10-01", "2021-10-01", 3, 0, 
					DataProvider.getStates().get("New"), DataProvider.getPriorities().get("Important"), 
					Arrays.asList(PlatformFabric.getPlatform("Xbox One"), 
							PlatformFabric.getPlatform("Xbox One X")), 
