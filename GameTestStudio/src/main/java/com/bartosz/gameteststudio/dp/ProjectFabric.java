...
public abstract class ProjectFabric {
	...
	public static HashMap<String, Project> map = new HashMap<String, Project>(){
		...
		private static final long serialVersionUID = 1L;
		{
			...
			put("FIFA 21", new Project("FIFA 21", "New features in FIFA 21...", 700, 900, "2020-01-01", "2020-10-11", 50 , StateFabric.getState("Closed"),(long)2,Arrays.asList(PlatformFabric.getPlatform("PlayStation 4"),PlatformFabric.getPlatform("PlayStation 5"),
					PlatformFabric.getPlatform("Xbox Series S"), PlatformFabric.getPlatform("Xbox Series X"))));
			put("NBA2K 22", new Project("NBA2K 22", "New features in NBA2K 22...", 600, 45, "2021-10-01", null, 100 , StateFabric.getState("Active"), (long)3,Arrays.asList(PlatformFabric.getPlatform("PlayStation 4"),PlatformFabric.getPlatform("PlayStation 5"),
					PlatformFabric.getPlatform("Xbox Series S"), PlatformFabric.getPlatform("Xbox Series X"))));
